...
urlpatterns = [
    ...
    # callback for password_reset_email and create token and uid inside it middleware and generate url if success url go to  success_url='password_reset_email_confirm' with token and uid
